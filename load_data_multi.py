...
from train_util import temporal_feature_extraction
...
def get_node_data(args):
    ...
    from train_util import create_dgl_graph, create_symbolic_rules, substitute_features
